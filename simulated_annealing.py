...
# To apply simulated annealing to new problems, just create a new class that inherits from SimulatedAnnealingOptimizer and overwrite 
# the step() and energy() methods
# -----------------------------------------------------------
